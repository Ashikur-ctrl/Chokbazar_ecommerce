            ...
            <form method="POST" action="{{ route('admin.sellers.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                                  class="mt-2 w-full rounded-lg border border-slate-300 px-4 py-2 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-200">{{ old('description') }}</textarea>
                    </div>
