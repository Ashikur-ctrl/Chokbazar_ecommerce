<x-admin-layout title="Create Seller">
    <div class="max-w-2xl mx-auto">
        <div class="rounded-card border border-gray-100 bg-white p-8 shadow-card">
            ...
            <form method="POST" action="{{ route('admin-legacy.sellers.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="{{ route('admin-legacy.sellers.index') }}" class="rounded-lg border border-slate-300 px-6 py-2 font-semibold text-slate-900 hover:bg-slate-50">
                            Cancel
                        </a>
                    </div>
                </form>
