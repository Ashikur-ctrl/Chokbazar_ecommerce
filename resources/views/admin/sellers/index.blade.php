<x-admin-layout title="Sellers">
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin-legacy.sellers.create') }}" class="rounded-lg bg-brand-600 px-4 py-2 text-sm font-bold text-white hover:bg-brand-700 transition-colors">
                + Add Seller
            </a>
        </div>
                        ...
                        @forelse($sellers as $seller)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-5 py-4 text-right space-x-2">
                                    <a href="{{ route('admin-legacy.sellers.show', $seller) }}" class="text-sm font-semibold text-brand-600 hover:text-brand-700">View</a>
                                    <a href="{{ route('admin-legacy.sellers.edit', $seller) }}" class="text-sm font-semibold text-gray-600 hover:text-gray-700">Edit</a>
                                </td>
                            </tr>
                        @empty
                            <tr><td colspan="7" class="px-5 py-12 text-center text-gray-500">No sellers found. <a href="{{ route('admin-legacy.sellers.create') }}" class="text-brand-600 hover:underline">Create one</a></td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
