    ...
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        @foreach([
            ...
            <div class="rounded-card border border-gray-100 bg-white p-6 shadow-card hover:shadow-card-hover transition-all duration-200">
                ...
                <a href="{{ route('admin-legacy.reports.export', $report[1]) }}" class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-brand-600 hover:text-brand-700 transition-colors">
