            ...
            <div class="lg:col-span-1">
                ...
                <p class="mt-3 text-sm text-gray-500 leading-relaxed">
	                ...
	                <div class="mt-5 flex gap-3">
	                    ...
	                    <a href="{{ config('services.social.facebook_url') }}" target="_blank" rel="noopener noreferrer" class="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-800 text-gray-400 hover:bg-brand-600 hover:text-white transition-all" aria-label="Facebook">
	                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
	                    </a>
	                    @endif
	                    @if(config('services.social.instagram_url'))
	                    <a href="{{ config('services.social.instagram_url') }}" target="_blank" rel="noopener noreferrer" class="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-800 text-gray-400 hover:bg-brand-600 hover:text-white transition-all" aria-label="Instagram">
	                    ...
	                    @endif
	                    @if(config('services.social.youtube_url'))
	                    <a href="{{ config('services.social.youtube_url') }}" target="_blank" rel="noopener noreferrer" class="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-800 text-gray-400 hover:bg-brand-600 hover:text-white transition-all" aria-label="YouTube">
