<x-seller-layout>
    ...
    <form method="POST" action="{{ route('seller.profile.update') }}" enctype="multipart/form-data" class="max-w-3xl space-y-8">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">{{ old('description', $seller->description) }}</textarea>
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea id="return_policy" name="return_policy" rows="2"
                              class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">{{ old('return_policy', $seller->return_policy) }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    ...
                    <textarea id="address" name="address" rows="2"
                              class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">{{ old('address', $seller->address) }}</textarea>
                </div>
                <div>
        ...
        <div class="flex items-center gap-4">
            <button type="submit" class="rounded-lg bg-orange-600 px-6 py-2.5 text-sm font-bold text-white hover:bg-orange-700">Save Changes</button>
        </div>
    </form>
</x-seller-layout>
