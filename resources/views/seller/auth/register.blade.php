    ...
    <div class="max-w-lg mx-auto">
        ...
        <form method="POST" action="{{ route('seller.register') }}" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 space-y-6">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="address" name="address" rows="2"
                                  class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500">{{ old('address') }}</textarea>
                    </div>
                    <div>
            ...
            <div class="text-sm text-gray-500 bg-gray-50 rounded-lg p-4">
                By registering, you agree to our <a href="#" class="text-orange-600 hover:underline">Terms of Service</a>.
            ...
            <p class="text-center text-sm text-gray-500">
                ...
                <a href="{{ route('seller.login') }}" class="text-orange-600 hover:underline font-medium">Log in</a>
            </p>
        </form>
    </div>
</x-guest-layout>
